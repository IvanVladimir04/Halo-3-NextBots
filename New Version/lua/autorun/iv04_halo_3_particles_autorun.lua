...
game.AddDecal( "iv04_halo_3_blood_splat_jackal", "effects/halo_3/decals/blood_jackal" ) 
game.AddDecal( "iv04_halo_3_blood_splat_grunt", "effects/halo_3/decals/blood_grunt" ) 
game.AddDecal( "iv04_halo_3_blood_splat_brute", "effects/halo_3/decals/blood_brute" ) 
game.AddDecal( "iv04_halo_3_blood_splat_drone", "effects/halo_3/decals/blood_drone" ) 
game.AddDecal( "iv04_halo_3_blood_splat_engineer", "effects/halo_3/decals/blood_engineer" ) 
game.AddDecal( "iv04_halo_3_blood_splat_flood", "effects/halo_3/decals/blood_flood" ) 